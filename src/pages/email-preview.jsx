  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1200, margin: '0 auto' }}>
      <Typography variant="h5" gutterBottom sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <Box sx={{ ml: 'auto' }}>
          <Button variant="outlined" sx={{ mr: 1 }}>Discard Changes</Button>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', my: 2 }}>
        <Typography variant="body1">When profiles are added, send this email</Typography>
        <Select
          value="immediately"
          size="small"
      ...
      <Box sx={{ 
        ...
        <Typography variant="body1" fontWeight="medium">Cold Email</Typography>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={7}>
          <Paper elevation={1} sx={{ p: 2, mb: 2 }}>
            ...
            <Typography variant="body2" sx={{ mb: 1 }}>Email Body</Typography>
            <Box sx={{ mb: 2 }}>
              <Button 
                variant="contained" 
                startIcon={<AIIcon />} 
              ...
              <Button size="small" variant="outlined" startIcon={<AddIcon />} sx={{ mr: 1, mb: 1 }}>First Name</Button>
              <Button size="small" variant="outlined" startIcon={<AddIcon />} sx={{ mr: 1, mb: 1 }}>Last Name</Button>
              <Button size="small" variant="outlined" startIcon={<AddIcon />} sx={{ mr: 1, mb: 1 }}>Full Name</Button>
              <Button size="small" variant="outlined" startIcon={<AddIcon />} sx={{ mr: 1, mb: 1 }}>Current Company</Button>
              <Button size="small" variant="outlined" startIcon={<AddIcon />} sx={{ mr: 1, mb: 1 }}>Current Job Title</Button>
              <Button size="small" variant="outlined" startIcon={<AddIcon />} sx={{ mr: 1, mb: 1 }}>Education</Button>
              <Button size="small" variant="outlined" startIcon={<AddIcon />} sx={{ mr: 1, mb: 1 }}>Field of Study</Button>
            </Box>
        ...
        <Grid item xs={12} md={5}>
          ...
          <Card elevation={1}>
            <CardContent>
              ...
              <Box sx={{ whiteSpace: 'pre-line', my: 2 }}>
                {emailBody}
              </Box>
            </CardContent>
          </Card>
          ...
          <Box sx={{ mt: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" gutterBottom>
              Test emails have "Test" in the subject line. You can send up to 10 per day.
            </Typography>
            <TextField
              fullWidth
